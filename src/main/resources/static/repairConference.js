...
function showMyConference() {
    ...
    for (var i in $queryConferenceByOrganizerId) {
        ...
        $listConference += '<div class="col-lg-3" style = "margin: 0px 10px;">' +
            ...
            '                            <div class="items">' +
            '                               <img class="img-responsive" src="picture/conference-img/conference' + ((con) % 10 + 1).toString() + '-img.jpg" />' +
            ...
            "<br>"+
            '            <!--按钮开始-->' +
            '            <button id="repair" type="button" class="btn btn-primary btn-sm" style = "margin-left:62px;" data-toggle="modal" data-target="#renyuan' + conferenceId + '">' +
            '                <span>修改</span>' +
            '            </button>' +
            '            <button id="deleteConference" type="button" class="btn btn-danger" style = "margin-left:20px;" onclick="deleteConference(' + conferenceId + ')">' +
            '                <span>删除</span>' +
            '            </button>' +
            '            <!--按钮结束-->' +
            '                            </div>' +
